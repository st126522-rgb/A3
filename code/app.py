...
# app.layout = dbc.Container([
#     html.H1("Car Price Quantile Prediction (Dummy)", className="text-center my-3"),

#     dbc.Alert([
#         html.H5("Instructions:", className="mb-2"),
#         html.Ul([
#             html.Li("Enter the car's manufacturing year, mileage, and max power."),
#             html.Li("Dummy model will always predict a static price range."),
#             html.Li("This is just for testing the UI.")
#         ])
#     ], color="info"),
...
#     # Dummy static prediction: always top 25%
#     dummy_pred = 3
#     range_text = interpret_quantile(dummy_pred)
#     return f"Your car's predicted price range: {range_text}"
